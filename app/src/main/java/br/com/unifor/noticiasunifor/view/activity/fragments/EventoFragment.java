 ...
 */
@EFragment(R.layout.fragment_evento)
public class EventoFragment extends Fragment {

    @ViewById(R.id.recycle_view_evento)
    protected RecyclerView recyclerViewEvento;
    ...
    @AfterViews
    public void afterViewa(){
        recyclerViewEvento.setAdapter(noticiasAdapter);
