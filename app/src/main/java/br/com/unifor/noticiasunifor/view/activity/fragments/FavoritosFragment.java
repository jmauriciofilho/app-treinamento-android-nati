...
public class FavoritosFragment extends Fragment {
    ...
    @ViewById(R.id.recycle_view_favoritos)
    protected RecyclerView recyclerViewNoticia;
    ...
    public void afterViews(){
        recyclerViewNoticia.setAdapter(noticiasAdapter);
    ...
    public void onResume() {
        super.onResume();
        noticiasAdapter.refreshFavoritos();
    }
